...
"color: rgb(0, 0, 0);")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 49, 671, 251))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(0, 0, 661, 384))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 638, 382))
...
"}")
        ...
        self.spinBox_AC_segundos.setGeometry(QtCore.QRect(400, 30, 31, 22))
...
"color: rgb(0, 0, 0);")
        ...
        self.spinBox_HDMI_segundos.setGeometry(QtCore.QRect(400, 70, 31, 22))
...
"}")
        ...
        self.spinBox_Fan_segundos.setGeometry(QtCore.QRect(400, 110, 31, 22))
...
"}")
        ...
        self.spinBox_LID_segundos.setGeometry(QtCore.QRect(400, 150, 31, 22))
...
"}")
        ...
        self.Texto_ServoMotor_por.setGeometry(QtCore.QRect(410, 190, 21, 16))
...
"}")
        ...
        self.Texto_ServoMotor_segundos.setGeometry(QtCore.QRect(560, 190, 61, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBox_ServoMotor_segundos.setGeometry(QtCore.QRect(460, 190, 31, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"color: rgb(0, 0, 0);")
        ...
        self.spinBox_ServoMotor_segundos.setMinimum(1)
        self.spinBox_ServoMotor_segundos.setObjectName("spinBox_ServoMotor_segundos")
        self.RecebeCurso_Cadastro = QtWidgets.QComboBox(parent=self.scrollAreaWidgetContents)
        self.RecebeCurso_Cadastro.setGeometry(QtCore.QRect(270, 190, 111, 22))
        self.RecebeCurso_Cadastro.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.RecebeCurso_Cadastro.setObjectName("RecebeCurso_Cadastro")
        self.RecebeCurso_Cadastro.addItem("")
        self.RecebeCurso_Cadastro.addItem("")
...
"}")
        ...
        self.Label_Diretorio_EXE_Touch.setGeometry(QtCore.QRect(170, 40, 291, 23))
...
"border-radius:5")
        ...
        self.Botao_DiretorioTouch.setGeometry(QtCore.QRect(470, 40, 25, 19))
...
"color: rgb(0, 0, 0);")
        ...
        self.Box_Valordeloop_Touch.setGeometry(QtCore.QRect(530, 40, 61, 23))
...
"color: rgb(0, 0, 0);")
        ...
        self.Texto_Loop_3.setGeometry(QtCore.QRect(170, 20, 251, 16))
        ...
        self.Texto_Loop_Touch.setGeometry(QtCore.QRect(530, 20, 47, 13))
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RecebeCurso_Cadastro.setItemText(0, _translate("MainWindow", "Servo Motor 1"))
        self.RecebeCurso_Cadastro.setItemText(1, _translate("MainWindow", "Servo Motor 2"))
